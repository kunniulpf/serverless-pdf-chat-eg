      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
            <h1>Gain instant access to accurate tax advice for specific business and personal situations</h1>
            <h2></h2>
            <div>
        ...
        <div className="row">
          ...
          <div className="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            ...
            <div className="icon-box">
              ...
              <h4 className="title"><a href="">Expert AI Tax Agent</a></h4>
              <p className="description">Built based on tax laws, court cases, authoritative commentaries, expert knowledge. </p>
            </div>

            <div className="icon-box">
              <div className="icon"><i className="bx bx-gift"></i></div>
              <h4 className="title"><a href="">Common Questions</a></h4>
              <p className="description">Provide well researched answers to common questions to ease navigation for junior accountants.</p>
            </div>

            <div className="icon-box">
              <div className="icon"><i className="bx bx-atom"></i></div>
              <h4 className="title"><a href="">Draft Email Correspondences</a></h4>
              <p className="description">Create professional draft emails with research findings.</p>
            </div>
          ...
          <div className="col-lg-4">
            <div className="info">
              <div className="address">
                ...
                <h4>Location:</h4>
                <p>Block 3, Blackrock Business Park, <br />
                Blackrock, Dublin, Ireland, A94D5D7</p>
              </div>
